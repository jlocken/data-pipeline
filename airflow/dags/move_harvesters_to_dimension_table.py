...
if __name__=='__main__':
    ...
    try:
        ...
        bit_harvesters = db.Table('bit_harvesters', metadata, autoload=True, autoload_with=engine,schema='steamaco_staging')
        query = db.select([bit_harvesters])
        ...
        while flag:
            ...
            if(partial_results)!=[]:
                ...
                query=params_dict['database']['queries']['insert_bitharvesters']
