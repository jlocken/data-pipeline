...
if __name__=='__main__':
    ...
    try:
        ...
        fetch_cols=params_dict['api_columns']['sites']
        
        sites_data_from_api= etl.get_data_from_api('sites',token, fetch_cols)
        
        #Dump customers data  into staging table customers
        etl.insert_data_into_database(engine, sites_data_from_api, 'sites', 'steamaco_staging', 1000)
